...
#with open('../data/Wave_partialobsmu_0.1.pkl', 'rb') as f: 
#      error1,normxtot1,normltot1, normutot1 = pickle.load(f)
     
with open('../data/Wave_partialobsmu_1.pkl', 'rb') as f: 
      error2,normxtot2,normltot2, normutot2 = pickle.load(f)


with open('../data/Wave_partialobsmu_10.pkl', 'rb') as f: 
      error3,normxtot3,normltot3, normutot3 = pickle.load(f)
      
with open('../data/Wave_partialobsmu_20.pkl', 'rb') as f: 
...
ax_soln[1].legend(loc="upper center", bbox_to_anchor=(0.53, 1.55), ncol=4)
...
for i in range(3):
    ...
    ax_soln[i].set_yticks([1e-3,1e-2,1e-1,1e-0])



plt.savefig('figs/wave_po.png', bbox_inches='tight', dpi=500)

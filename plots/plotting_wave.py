...
#with open('../data/Wavemu_0.1.pkl', 'rb') as f: 
#      error1,normxtot1,normltot1, normutot1 = pickle.load(f)
     
with open('../data/Wavemu_1.pkl', 'rb') as f: 
      error2,normxtot2,normltot2, normutot2 = pickle.load(f)

with open('../data/Wavemu_10.pkl', 'rb') as f: 
      error3,normxtot3,normltot3, normutot3= pickle.load(f)

with open('../data/Wavemu_20.pkl', 'rb') as f: 
      error4,normxtot4,normltot4, normutot4= pickle.load(f)

#with open('../data/Wavemu_30.pkl', 'rb') as f: 
#      error5,normxtot5,normltot5, normutot5= pickle.load(f)
...
#ax_soln[0].plot(error5[:, 0]/normxtot5, label='$\mu=30$')
...
#ax_soln[1].plot(error5[:, 1]/normxtot5, label='$\mu=30$')
...
#ax_soln[2].plot(error5[:, 2]/normxtot5, label='$\mu=30$')
...
plt.savefig('figs/wave.png', bbox_inches='tight', dpi=500)

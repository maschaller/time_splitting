...
#with open('../data/Adv_Diff3_partialobsmu_0.1.pkl', 'rb') as f: 
#      error1,normxtot1,normltot1, normutot1 = pickle.load(f)
     
with open('../data/Adv_Diff3_partialobsmu_1.pkl', 'rb') as f: 
      error2,normxtot2,normltot2, normutot2 = pickle.load(f)

with open('../data/Adv_Diff3_partialobsmu_10.pkl', 'rb') as f: 
      error3,normxtot3,normltot3, normutot3= pickle.load(f)

with open('../data/Adv_Diff3_partialobsmu_20.pkl', 'rb') as f: 
...
for i in range(3):
    ax_soln[i].set_xticks([0,100,200,300,400])
...
plt.savefig('figs/heat_po.png', bbox_inches='tight', dpi=500)

...
scipy.sparse.save_npz('../mats/A_ad3_coarse.npz', ANP1)
...
scipy.sparse.save_npz('../mats/B_ad3_coarse.npz', BNP)
scipy.sparse.save_npz('../mats/C_ad3_coarse.npz', CNP)
scipy.sparse.save_npz('../mats/Mass_ad3_coarse.npz', MassNP)
